...
<title>@yield('title') | Chiến Đồ Nam</title>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{ asset('admin/home') }}">Chiến Đồ Nam Admin</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="comment-btn"><a style="display: flex !important; align-items: center;" href="{{ asset('admin/revenue') }}"><i style="font-size: 18px; margin-right: 8px;" class="fa fa-money" aria-hidden="true"></i> Doanh thu</a></li>
            <li role="presentation" class="divider"></li>
		</ul>
	</div><!--/.sidebar-->
